...
class Inventar:
    def __init__(self, screen, clock):
        ...
        for skin in self.skins:
            ...
            bild = pygame.transform.scale(bild, (bild.get_width() * 3, bild.get_height() * 3))
    ...
    def texte_und_rects(self):
        ...
        self.ausruesten_text_rects = []
        self.information_text_circles = []
        self.upgrade_text_rects = []

        for waffe in self.waffen:
            y = waffe[2]
            self.ausruesten_text_rects.append(pygame.Rect(GV.SCREEN_WIDTH - GV.SCREEN_WIDTH / 3 + 50, y + 20, 220, 40))
    ...
    def handle_event(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            for waffe in self.waffen:
                ...
                if self.ausruesten_text_rects[index].collidepoint(event.pos):
                    if self.inhalt[index][name]["Verfuegbarkeit"] == "False":
                        self.auswahl_setzen(index)
    ...
    def draw(self):
        ...
        for waffe in self.waffen:
            ...
            self.screen.blit(ausruesten_text, self.ausruesten_text_rects[index])
    ...
    def draw_skins(self):
        for skin in self.skins:
            ...
            pygame.draw.rect(self.screen, farbe, (60, y - 10, 110, 100))

            skin_image_rect = pygame.Rect(70, y, 80, 80)
